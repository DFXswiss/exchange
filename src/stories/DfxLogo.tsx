      ...
      <svg width="80" height="25" viewBox="0 0 80 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_685_7455)">
          <g clip-path="url(#clip1_685_7455)">
            ...
            />
            <path
              d="M12.67 18.5699C16.1498 18.5699 18.9708 15.749 18.9708 12.2691C18.9708 8.78924 16.1498 5.96826 12.67 5.96826C9.19012 5.96826 6.36914 8.78924 6.36914 12.2691C6.36914 15.749 9.19012 18.5699 12.67 18.5699Z"
              fill="url(#paint0_linear_685_7455)"
            />
            <path
              d="M6.93197 19.4333C10.7604 19.4333 13.8639 16.3297 13.8639 12.5013C13.8639 8.67289 10.7604 5.56934 6.93197 5.56934C3.10355 5.56934 0 8.67289 0 12.5013C0 16.3297 3.10355 19.4333 6.93197 19.4333Z"
              fill="url(#paint1_linear_685_7455)"
            />
          </g>
        </g>
        <defs>
          <linearGradient
            id="paint0_linear_685_7455"
            x1="17.9571"
            y1="9.51159"
            x2="6.75873"
            y2="15.2868"
